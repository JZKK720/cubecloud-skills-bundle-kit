---
name: impeccable-operate
description: "Extended design depth for Operate-mode surfaces where the interface serves the product: app UIs, admin dashboards, settings panels, data tables, and authenticated tools. Use when the user is in a task rather than being persuaded. Covers the product slop test, earned familiarity as the bar, and the typography and consistency rules that Read surfaces share."
license: Apache-2.0
---

# Operate mode depth (and Read notes)

When design SERVES the product: app UIs, admin dashboards, settings panels, data tables, tools, authenticated surfaces, anything where the user is in a task. The essentials live in SKILL.md's modes and the craft-floor checklist; this file is extended depth, written for Operate surfaces. Read surfaces (docs, guides, long-form) take SKILL.md's Read mode plus this file's typography and consistency rules; their prose measure and navigation matter more than component density.
