...
description: "Reduce visual intensity in a design that is too loud, aggressive, or overstimulating without losing personality or collapsing into generic. Use when a surface demands attention it has not earned, or reads exhausting to use. Covers desaturating and softening palettes, reducing visual weight, cutting decorative motion and effects, and refinement through restraint."
license: Apache-2.0
---
