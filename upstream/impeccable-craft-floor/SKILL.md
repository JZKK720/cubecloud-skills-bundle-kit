...
description: "The non-negotiable quality floor and absolute bans to verify immediately before shipping any UI. Use as a final pre-ship checklist on a built result, not as an intention. Covers contrast ratios, real shadow depth, focus visibility, motion respect, and the mechanical defects that design review tends to miss."
license: Apache-2.0
---

# Craft floor

Load this after the direction is settled, and build without announcing the checklist. A pinned brief or the committed visual world overrides anything here; your own habit does not. Run the checks below in your verification pass before shipping.
