...
description: "Identify reusable patterns, components, and design tokens in a codebase and consolidate them into the design system for systematic reuse. Use when repeated UI has drifted into near-duplicates, or when a design system exists but is being bypassed. Discovers the existing system first and refuses to invent a new one without being told where it belongs."
license: Apache-2.0
---
...
**CRITICAL**: If no design system exists, do not create one yet. STOP and ask the user
