...
description: "Find and fix the actual performance bottleneck in an interface, then measure the result. Use when an interface is measurably slow, or when performance is a stated requirement. Covers Core Web Vitals (LCP, INP, CLS), load time, bundle size, render cost, and the discipline of not optimizing what is not slow."
license: Apache-2.0
---
