---
name: impeccable-android
description: "Android platform conventions for native apps built with Jetpack Compose, Android Views, React Native, Expo, or Flutter. Use when building or reviewing Android UI. Covers Material Design 3 as the governing rulebook, expressing brand through Material theming, the Android slop test for off-spec components, and the OS guarantees iOS hardware still owes."
license: Apache-2.0
---
