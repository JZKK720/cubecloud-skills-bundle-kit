...
description: "Discover what should be made and how it should work, then return a confirmed design brief without writing code. Use before building a new surface or feature when the requirements are still open. Runs a bounded discovery interview on purpose, audience, material, and boundaries, resolves direction, then writes the smallest useful brief and stops."
license: Apache-2.0
---
