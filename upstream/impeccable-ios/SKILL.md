---
name: impeccable-ios
description: "iOS and iPadOS platform conventions for native apps built with SwiftUI, UIKit, React Native, Expo, or Flutter. Use when building or reviewing iOS UI. Covers Human Interface Guidelines conformance as the governing rulebook, expressing brand through the layer the platform leaves open, and the iOS slop test for controls that read as ported from a website."
license: Apache-2.0
---
