...
description: "Make an interface resilient to the unexpected: edge cases, hostile input, failure states, interrupted gestures, and real-world conditions. Use when an interface works only on the happy path, or before shipping anything users can break. Covers constraint handling, validation, accessibility and performance resilience, offline behavior, and the edge-case test matrix."
license: Apache-2.0
---
