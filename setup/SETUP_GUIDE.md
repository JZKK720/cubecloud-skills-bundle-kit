...
| 4     | Install 246 manifest entries (245 active + 1 disabled) through the security-gated pipeline; combined with extension/CLI-provisioned skills this yields 294 dirs in `~/.agents/skills/`                                                                          | ~5 min  |
...
**246 manifest entries (245 active + 1 disabled) + extension/CLI-provisioned and hand-ported skills = 294 dirs in `~/.agents/skills/`** (discovered by VS Code Copilot Chat):
