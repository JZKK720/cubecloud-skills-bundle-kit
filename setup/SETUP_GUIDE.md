...
| 4     | Install 238 manifest entries (237 active + 1 disabled) through the security-gated pipeline; combined with extension/CLI-provisioned skills this yields 286 dirs in `~/.agents/skills/`                                                                          | ~5 min  |
...
**238 manifest entries (237 active + 1 disabled) + extension/CLI-provisioned and hand-ported skills = 286 dirs in `~/.agents/skills/`** (discovered by VS Code Copilot Chat):
