...
| 4     | Install 240 manifest entries (239 active + 1 disabled) through the security-gated pipeline; combined with extension/CLI-provisioned skills this yields 288 dirs in `~/.agents/skills/`                                                                          | ~5 min  |
...
**240 manifest entries (239 active + 1 disabled) + extension/CLI-provisioned and hand-ported skills = 288 dirs in `~/.agents/skills/`** (discovered by VS Code Copilot Chat):
