...
| 4     | Install 249 manifest entries (248 active + 1 disabled) through the security-gated pipeline; combined with extension/CLI-provisioned skills this yields 294 dirs in `~/.agents/skills/`                                                                          | ~5 min  |
...
**249 manifest entries (248 active + 1 disabled) + extension/CLI-provisioned and hand-ported skills = 294 dirs in `~/.agents/skills/`** (discovered by VS Code Copilot Chat):
