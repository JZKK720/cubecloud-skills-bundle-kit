...
| 4     | Install 195 manifest entries (194 active + 1 disabled) through the security-gated pipeline; combined with extension/CLI-provisioned skills this yields 228 dirs in `~/.agents/skills/`                                                                          | ~5 min  |
...
**194 manifest entries (194 active + 1 disabled) + 47 extension/CLI-provisioned and hand-ported skills = 228 dirs in `~/.agents/skills/`** (discovered by VS Code Copilot Chat):
